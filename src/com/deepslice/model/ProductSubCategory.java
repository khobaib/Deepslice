...
public class ProductSubCategory implements Serializable {
    ...
    public static List<ProductSubCategory> parseProductSubcategories(JSONArray subcatArray){
        ...
        try {
            for(int i=0; i<subcatArray.length(); i++){
                ...
                JSONObject thisLocation = subcatArray.getJSONObject(i);
                if(thisLocation!=null){
                    String jsonString = thisLocation.toString();
                    //                aBean=new DelLocations();
                    ProductSubCategory subcategory=gson.fromJson(jsonString, ProductSubCategory.class);
